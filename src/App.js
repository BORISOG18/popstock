    ...
    <div style={S.app}>
      ...
      <div style={S.content}>
        ...
        {activeTab==='Stock Manager'&&(<div>
          ...
          <div className="card">
            <div className="tbl-wrap"><table className="tbl"><thead><tr><th>BULK ID</th><th>POP/ITEM</th><th>ITEMS</th><th>USED</th><th>AVAIL</th><th>POP LEFT</th><th>₹ VALUE</th><th>STATUS</th><th></th></tr></thead>
              <tbody>
        ...
        {activeTab==='Order History'&&(<div>
          ...
          <div className="card">
            <div className="tbl-wrap"><table className="tbl"><thead><tr><th>ORDER ID</th><th>CUSTOMER</th><th>POP</th><th>ITEMS</th><th>IDs</th><th>EARNINGS</th><th>DATE</th><th>ACTIONS</th></tr></thead>
              <tbody>
